...
<CardGroup cols={3}>
  <Card title="Research Agent" href="https://github.com/superserve-ai/superserve/tree/main/guides/managed-agents/claude-managed-agents/recipes/research-agent">
  ...
  <Card title="Persistent Dev Environment" href="https://github.com/superserve-ai/superserve/tree/main/guides/managed-agents/claude-managed-agents/recipes/dev-environment">
  ...
  <Card title="Parallel Benchmark Agent" href="https://github.com/superserve-ai/superserve/tree/main/guides/managed-agents/claude-managed-agents/recipes/parallel-benchmark-agent">
...
<CardGroup cols={2}>
  ...
  <Card title="Reference implementation" href="https://github.com/superserve-ai/superserve/tree/main/guides/managed-agents/claude-managed-agents">
