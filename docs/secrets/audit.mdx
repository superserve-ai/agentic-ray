...
<Tip>
For the full picture of a single sandbox's traffic — not just secret-bearing requests, but every HTTP and HTTPS connection it made — use the [network log](/sandbox/network-log).
</Tip>
